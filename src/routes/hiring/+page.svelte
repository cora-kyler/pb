...
<div class="mx-auto max-w-[900px] px-6 py-4 md:py-10 min-h-[80vh]">
	<a href="/#team" class="font-mono text-xs text-pink hover:underline transition-colors mb-8 inline-block">← Team</a>
		...
		<div class="bg-light-grey/40 border border-dark-grey/10 rounded-lg p-4 md:p-6 mt-10 md:mt-16 flex gap-4 md:gap-6 items-start leading-[1.4em]">
			<div class="flex-1">
				...
				<div class="text-xs md:text-sm text-dark-grey/80 leading-relaxed space-y-3">
					...
					<p>We'll read everything.</p>
				</div>
			</div>
			<img src="/marker.svg" alt="" class="w-12 h-12 md:w-24 md:h-24 shrink-0" />
		</div>
	</section>
</div>
